<template>
  <div>
    ...
    <div class="color"></div>
      ...
      <div class="anquan">
        <span>
          如果我们在车内留心观察，一定不难发现一个“禁止让乘坐安全座椅的儿童坐在有安全气囊的座位”的图标。儿童是否在任何情况下都不可以坐在
          有安全气囊的座位上？如果可以。什么情况下可以？
        </span>
      </div>
    </div>
    <div class="safety">
    ...
    <div class="safety">
      ...
      <div class="anquan">
        <span>
          在车内放置一些生活物品或者污染物或者携带宠物乘车是一件在大多数人看来再正常不过的事情。但你是否知道，汽车在发生意外事故时，这些看起来微不足道的
          生活物品，也有可能给孩子带来致命伤害？
        </span>
      </div>
    </div>
